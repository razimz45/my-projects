...
"[project]/app/menu/new/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewMenuPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            setSaving(true);
            const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMenu"])({
                name: name.trim(),
                description: description.trim()
            });
            // If your backend returns the created menu object with _id:
            if (created && created._id) {
                router.push("/menu/".concat(created._id));
            } else {
                router.push("/");
            }
        } catch (e) {
...
_s(NewMenuPage, "y48JzzsrxDvGiX0dCqNx4Jg3d08=", false, function() {
    return [
...
_c = NewMenuPage;
var _c;
__turbopack_context__.k.register(_c, "NewMenuPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_639c3cd2._.js.map